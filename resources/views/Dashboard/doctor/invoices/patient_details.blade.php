                                                    ...
                                                    <tbody>
                                                        @foreach ($patient_rays as $patient_ray)
                                                            <tr>
                                                                ...
                                                                <td>{{ $patient_ray->employee->name ?? 'لا يوجد موظف ' }}
                                                                </td>
                                                            ...
                                                            @include('Dashboard.doctor.invoices.xray.edit_xray_conversion')
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tbody>
                                                        @foreach ($patient_Laboratories as $patient_Laboratorie)
                                                            ...
                                                            @include('Dashboard.doctor.invoices.laboratorie.edit_laboratorie_conversion')
                                                            @include('Dashboard.doctor.invoices.laboratorie.deleted_laboratorie')
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
