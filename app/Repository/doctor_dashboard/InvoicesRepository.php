...
class InvoicesRepository implements InvoicesRepositoryInterface
{
    ...
    public function show($id)
    {
        ...
        return view('Dashboard.Doctor.invoices.xray.view_rays', compact('rays'));
    }
    ...
    public function showLaboratorie($id)
    {
        ...
        return view('Dashboard.Doctor.invoices.laboratorie.view_laboratories', compact('laboratories'));
    }
}
