            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    {{-- <div class="dropdown-menu dropdown-notifications">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <p data-count ="0" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">0</p>
                        </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('Dashboard/img/faces/18.jpg') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('Dashboard/img/faces/18.jpg') }}" class=""></div>
...
<script>
    Echo.private('create-invoice.{{ auth()->user()->id }}').listen('.create-invoice', (data) => {
        // إنشاء رسالة التنبيه
        var notificationMessage = `إشعار جديد: ${data.message} ${data.patient}\nتم إنشاؤه في: ${data.created_at}`;
        
        // عرض الرسالة باستخدام alert
        alert(notificationMessage);

        // يمكنك تسجيل البيانات في Console أيضًا
...
var pusher = new Pusher('09a59ed2e58763155ba0', {
  cluster: 'mt1',
  forceTLS: true
});
...
{{-- هذه الكود مش شغال خالص حق الاشعارت  --}}
