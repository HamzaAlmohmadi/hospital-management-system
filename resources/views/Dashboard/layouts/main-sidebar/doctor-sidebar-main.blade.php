    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('Dashboard/1.png') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices.index') }}">قائمة الفواتير تحت الاجراء </a></li>
                    <li><a class="slide-item" href="{{ route('completedInvoices') }}">قائمة الفواتير المكتملة</a></li>
