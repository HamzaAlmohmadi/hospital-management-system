                ...
                <div class="card-body">
                    <form action="{{ route('Payment.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label>الرصيد المتبقي للمريض </label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" id="final_balance" name="final_balance" value="0.00" type="text" readonly>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#patient_id').change(function() {
                ...
                if (patientId) {
                    $.ajax({
                        url: '{{ url("patient/balance") }}/' + patientId,
                        type: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            if (data.success) {
                                $('#final_balance').val(data.balance);
                            } else {
                                $('#final_balance').val('0.00');
                            }
                        }
                    });
                } else {
