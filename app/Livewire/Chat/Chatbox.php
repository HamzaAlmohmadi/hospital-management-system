...
class Chatbox extends Component
{
    ...
    public function load_conversationDoctor( Conversation $conversation,Doctor $receiverUser)
    {
    ...
    public function load_conversationPatient(Conversation $conversation, Patient $receiverUser)
    {
