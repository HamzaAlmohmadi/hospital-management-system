...
Route::group(
    ...
    require __DIR__ . '/auth.php';
        ...
        //############################# Chat route ##########################################
         Route::get('list/doctors',Createchat::class)->middleware(['auth:patient'])->name('list.doctors');
         Route::get('chat/doctors',Main::class)->middleware(['auth:patient'])->name('chat.doctors');
        //############################# end Chat route ######################################