                                        ...
                                        <div class="main-signup-header">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="sectionChooser">
                                                    ...
                                                    <option value="ray_employee"> الدخول دكتور اشعة </option>
                                                    <option value="laboratorie_employee"> الدخول دكتور مختبر  </option>
                                                    {{-- <option value="patient"> الدخول  مريض   </option> --}}
                                                </select>
                                            </div>
